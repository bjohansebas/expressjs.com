...
For details, see [Application settings](/5x/api#application-settings).
:::
...
:::
  ...
  `env`
      ...
      see <a href="/advanced/best-practice-performance">Production best practices: performance and reliability</a>.
    </td>
  <td markdown="1">
...
When the [`trust proxy` setting](#options-for-trust-proxy-setting)
...
Later, you may access this value through the [req.signedCookies](#reqsignedcookies) object.
