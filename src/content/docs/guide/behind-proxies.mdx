...
<ul>
  <li markdown="1">
    The value of [req.hostname](/4x/api#reqhostname) is derived from the
  ...
  <li markdown="1">
    ...
    [req.protocol](/4x/api#reqprotocol).
  </li>
  <li markdown="1">
    The [req.ip](/4x/api#reqip) and [req.ips](/4x/api#reqips) values are
