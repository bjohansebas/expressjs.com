...
<ul class="doclist">
  <li>
    <a href="#changes-in-express-4">Changes in Express 4</a>.
  </li>
  <li>
    <a href="#example-app-migration">An example</a> of migrating an Express 3 app to
    Express 4.
  </li>
  <li>
    <a href="#upgrading-to-the-express-4-app-generator">Upgrading to the Express 4 app generator</a>.
  </li>
</ul>
...
<ul class="doclist">
  <li>
    <a href="#changes-to-express-core-and-middleware-system">Changes to Express core and middleware system.</a>{" "}
    The dependencies on Connect and built-in middleware were removed, so you
    must add middleware yourself.
  </li>
  <li>
    <a href="#the-routing-system">Changes to the routing system.</a>
  </li>
  <li>
...
#### <code>app.use</code> accepts parameters
...
#### <code>express.Router</code> class
...
<table class="doctable" border="1">
  ...
  <tr>
    ...
    <td markdown="1">
      The `http` module is no longer needed, unless you need to directly work
      with it (socket.io/SPDY/HTTPS). The app can be started by using the
      `app.listen()` function.
    </td>
  </tr>
  <tr>
    ...
    <td markdown="1">
      ...
      `process.env.NODE_ENV` or `app.get('env')` function to detect the
      environment and configure the app accordingly.
    </td>
  </tr>
  <tr>
    <td markdown="1">`json spaces`</td>
    <td markdown="1">
      The `json spaces` application property is disabled by default in Express
      4.
    </td>
  </tr>
  <tr>
    ...
    <td markdown="1">
      Use `req.accepts()`, `req.acceptsEncodings()`, `req.acceptsCharsets()`,
