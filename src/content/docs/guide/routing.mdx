...
see [app.METHOD](/4x/api.html#app.METHOD). You can also use [app.all()](/4x/api.html#app.all) to handle all HTTP methods and [app.use()](/4x/api.html#app.use) to
...
For a full list, see [app.METHOD](/4x/api.html#app.METHOD).
