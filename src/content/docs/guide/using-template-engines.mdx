...
To render template files, set the following [application setting properties](/4x/api#appsetname-value), set in `app.js` in the default app created by the generator:
...
["Developing template engines for Express"](/advanced/developing-template-engines).
