...
<PackageManagerCommand npx="express-generator" />
...
<FileTree>
  - app.js - bin - www - package.json - public - images - javascripts -
  stylesheets - style.css - routes - index.js - users.js - views - error.pug -
