...
<PackageManagerCommand npx="express-generator" bunx="express-generator" pnpx="express-generator" />

For earlier Node versions, install the application generator as a global npm package and 

<PackageManagerCommand npm="install -g express-generator" bun="install -g express-generator" pnpm="install -g express-generator" />
...
:::note
  ...
  structure Express apps. Feel free to use this structure or modify it to best
  suit your needs.
:::